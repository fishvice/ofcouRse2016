...
http://www.hafro.is/~einarhj/education/rhafro2016/ggplot2.html
...
Get the data into your R-environment
...
![rtfm](img/rtfm_mao.png)

* The ggplot2 site (cookbook): http://docs.ggplot2.org/current
...
Repeat previous plots or do new ones, but using the google base. E.g.:
...
You could also ask your college for help. Just don't ask the same question twice too often :-)
